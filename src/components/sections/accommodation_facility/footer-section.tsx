...
export function FooterSection({ content }: FooterSectionProps) {
  const { description, legalLinks, quickLinks, socialLinks, copyright, contact } = content
  const currentYear = new Date().getFullYear()

  return (
    <footer id="contatti" className="bg-foreground text-background py-16 md:py-24">
      <div className="container mx-auto px-6">
        {/* Main Footer Content */}
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          {/* Brand Column */}
          <div className="lg:col-span-2">
            <Link href="/" className="font-serif text-3xl font-medium mb-6 block">
              {}
            </Link>
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-sm uppercase tracking-wider mb-6 text-background/50">
              Esplora
            </h3>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-background/70">{contact?.address}</p>
            </div>
          </div>
        </div>
